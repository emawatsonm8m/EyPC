...
MISILES_JUGADOR proc
    ...
    cmp ax, 5          ; Verifica si han pasado 18 ticks (aprox. 1 segundo)
...
Ciclo_cj:
    ...
    ; impacto: borrar misil y hacer retroceder enemigo
    mov al,[mis_j_col+si]
    mov [col_aux],al
    mov al,[mis_j_ren+si]
    mov [ren_aux],al
    ...
    mov al,[enemy_ren]
    sub al,3          ; ← Si quieren que lo recorra menos cambienlo a 2
    mov [enemy_ren],al
...
ok_clip:
    ...
    ; frena avance vertical por un tiempo
    mov ah,00h
    int 1Ah
