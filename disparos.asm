...
;Temporizadores y la parte de hacerlo aleatorio
t_mis_j dw 0 
t_mis_e dw 0 
seed dw 0ACE1h
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    Dibujar_Misil_J proc
      posiciona_cursor [ren_aux], [col_aux]
      imprime_caracter_color 24d, cBlanco, bgNegro
      ret
    endp
    ...
    Dibujar_Misil_E proc
      posiciona_cursor [ren_aux], [col_aux]
      imprime_caracter_color 'V',cRojo,bgNegro
      ret
    endp
...
Ciclo_cj:
    ...
    ; retroceder enemigo sin salir de cuadro
    ; borramos al enemigo
    call ELIMINA_ENEMIGO

    ; subir una fila 
    dec byte ptr [enemy_ren]
    ; clip superior
    mov al,[enemy_ren]
    cmp al,3
    jge ok_clip
...
ok_clip:
    ...
    ;frena el avance vertical por un tiempo
    mov ah,00h
    int 1Ah
